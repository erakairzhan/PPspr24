...
conn = psycopg2.connect("dbname=snake_game user=postgres password = Yer@Yer@ssyl")
cur = conn.cursor()
...
font_menu_user = pygame.font.SysFont('Arial', 40, bold=True)
...
game_background =  pygame.image.load("/Users/erakairzhan/Desktop/PPspr24/lab10/images/game_background.jpg")
menu_background =  pygame.image.load("/Users/erakairzhan/Desktop/PPspr24/lab10/images/menu_background.jpg")
